(function() {
  ...
  window.updateDriverQuickStats = updateDriverQuickStats;
  window.updateActiveRoutePanel = updateActiveRoutePanel;
  window.showNavigationPanel = showNavigationPanel;
  window.renderPerformanceStats = renderPerformanceStats;
  window.initMobileDriverNav = initMobileDriverNav;
  window.setMobileNavActive = setMobileNavActive;
  window.updateMobileGpsButton = updateMobileGpsButton;
  window.updateMobileRouteIndicator = updateMobileRouteIndicator;
